...
export const array = [
    {
        ...
        cor3: "#606166",
        cora: <Heart />,
        desc: "O smartwatch que oferece o mais completo conjunto de funções de monitoramento para o acompanhamento da Saúde e do Bem-Estar de uma maneira precisa e confiável. Possui os recursos essenciais e mais avançados para medir e acompanhar o estado da sua Saúde, funções como monitor de Batimento Cardíaco, Pressão Arterial, Eletrocardiograma, Oxímetro, Detecção de Queda e Chamada de Emergência, programa de Coaching do Sono para monitorar e melhorar a qualidade do seu Sono , além da Bioimpedância para avaliar a composição corporal de maneira rápida e interativa, e verificar a evolução os resultados dos exercícios refletidos no seu corpo. Possui uma série de funções avançadas de treinos com mais de 95 modalidades. Design Circular, Combinado com as diferentes opções de novas cores se unem na expressão do seu estilo. O Galaxy Watch5 tem alta durabilidade com uma tela de Cristal Safira, além do seu corpo feito em alumínio reforçado. Resistência a água com profundidade de até 50m, e  mais a proteção contra poeira (IP67). Ele vem ainda com 33 mostradores de tela pré-embarcados, selecionáveis e que podem ser personalizados para os mais diferentes propósitos de uso de acordo com o seu visual e a sua rotina diária. Sua bateria tem maior capacidade de duração, e rapidez de carregamento, atinge 45% de bateria em apenas 45 minutos. Equipado com o sistema operacional Google Wear OS Powered by Samsung que dá acesso aos aplicativos mais populares como o Google Maps, Play Store e o Youtube music diretamente do seu pulso. Vem ainda com uma série de funções que vão facilitar o seu dia-a-dia seja no lazer ou no trabalho, como o controlador de câmera, controlador de músicas remoto, controle de PPT, e pagamento móvel com o Samsung Pay.",
    },
    {
        id: 10,
        dis: "513",
    ...
    },
    {
        ...
        cor3: "#252525",
        cora: <Heart />,
        desc: "O Bip 3 possui uma tela AMOLED de 1,69 polegadas, com cobertura de vidro temperado 2.5D e um revestimento que evita a marca de dedos. Outro destaque do dispositivo é a sua bateria de 280 mAh, que promete durar até até 14 dias seguidos de uso típico. Quanto as atividades físicas, o Bip 3 oferece 60 modos para esportes; como caminhada, corrida, ciclismo, treino de força e ioga; o smartwatch possui o recurso Target Pace, que permite ao usuário definir metas de ritmo.",
    },
    {
        id: 3,
        dis: "534",
        ...
        cor3: "#F3F2F0",
        cora: <Heart />,
        desc: "Monitore sua frequência cardíaca e receba notificações se ela estiver muito alta ou baixa ou com ritmo irregular.(1) Calcule seus exercícios, acompanhe e compartilhe suas atividades com os amigos. Atenda ligações, responda a mensagens e sincronize suas músicas e podcasts preferidos. Com o Apple Watch Series 3, você faz tudo direto do seu pulso.",
    },
    {
        id: 4,
        dis: "99",
        ...
        cor3: "#FFFFFF",
        cora: <Heart />,
        desc: "O Apple Watch Series 8 tem sensores e apps avançados de saúde, que permitem fazer um ECG, ver sua frequência cardíaca e o nível de oxigênio no sangue e acompanhar as variações de temperatura para informações detalhadas sobre seu ciclo menstrual. Além disso, a Detecção de Acidente, o monitoramento dos estágios do sono e as métricas avançadas de exercícios ajudam você a ter uma vida ativa, saudável, segura e conectada.",
    },
    {
        id: 5,
        dis: "24",
    ...
    },
    {
        ...
        cor3: "#F4E0D9",
        cora: <Heart />,
        desc: "Combinando uma aparência elegante e um monitoramento sofisticado, o.gts 2e gps smartwatch da amazfit é um companheiro ideal que parece ótimo enquanto o ajuda a se manter saudável e atingir seus objetivos de fitness. Ele ostenta uma tela amoled quadrada de 1.65 que é sua janela para o monitoramento detalhado de saúde e condicionamento físico. Para ajudá - lo a manter a forma no exercício de sua escolha, o gts 2e oferece suporte a 90 modos esportivos integrados, 6 dos quais são convenientemente reconhecidos automaticamente, e rastreamento gps.com construção à prova d'água que pode suportar profundidades de até 164 pés, o gts 2e pode ser usado em terra e na piscina.",
    },
    {
        id: 11,
        dis: "432",
